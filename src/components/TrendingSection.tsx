...
const TrendingSection: React.FC = () => {
  ...
  const popularCategories = [
    { name: 'Food & Dining', businesses: '12,500+', icon: '🍽️', color: 'bg-orange-100 text-orange-700' },
    { name: 'Healthcare', businesses: '8,200+', icon: '🏥', color: 'bg-red-100 text-red-700' },
    { name: 'Education', businesses: '6,800+', icon: '📚', color: 'bg-blue-100 text-blue-700' },
    { name: 'Automotive', businesses: '5,400+', icon: '🚗', color: 'bg-gray-100 text-gray-700' },
    { name: 'Beauty & Spa', businesses: '4,900+', icon: '💄', color: 'bg-pink-100 text-pink-700' },
    { name: 'Home Services', businesses: '7,600+', icon: '🏠', color: 'bg-green-100 text-green-700' },
    { name: 'Shopping', businesses: '9,300+', icon: '🛍️', color: 'bg-purple-100 text-purple-700' },
    { name: 'Travel & Hotels', businesses: '3,200+', icon: '✈️', color: 'bg-indigo-100 text-indigo-700' }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
          <div className="text-center mb-8">
            ...
            <p className="text-purple-100">Trusted by millions of users across India</p>
          </div>
