...
import {
  Megaphone, Tractor, Shirt, Car, Settings, Baby, CreditCard, PartyPopper,
  Scissors, Palette, BookOpen, Hammer, Truck, ChefHat, Pill, Users, Computer,
  Package, Milk, Music, Microscope, Stethoscope, GraduationCap, Zap, Tv,
  Calendar, Eye, Utensils, Dumbbell, Flower, Sofa, DollarSign, Fuel, Gift,
  Store, Heart, Wrench, Hospital, Bed, Building2, Home, IceCream, PaintBucket,
  Wifi, Shield, Gem, Briefcase, Smartphone, Camera, MapPin, PawPrint, Building,
  School, ShieldCheck, Plane, Coffee, PaintRoller, Lamp, Guitar, Apple, ShoppingCart,
  Printer, Tent, University, Battery,  Monitor, X, Droplet,
  Aperture,
  Video,
  Pencil,
  Sun,
...
export const categoryIcons = {
  ...
  "Automobiles (Car, Bike, Showroom, Service)": { icon: Car, color: "text-gray-600" },
  ...
  "Dry Cleaners & Laundry Services": { icon: CloudSnow, color: "text-blue-300" },
  ...
  "Laboratories (Medical/Industrial)": { icon: Microscope, color: "text-teal-400" },
  ...
  "Online Shopping / E-commerce Support": { icon: ShoppingCart, color: "text-blue-500" },
  ...
  "Repair Services (AC, Fridge, Washing Machine)": { icon: Wrench, color: "text-gray-700" },
  "Resorts & Holiday Homes": { icon: Home, color: "text-blue-500" },
  "Solar Dealers (Water Heater, Rooftop)": { icon: Sun, color: "text-yellow-600" },
  ...
  "Water Suppliers (20L Jar, Tanker)": { icon: Droplet, color: "text-blue-400" },
  ...
  "Yellow Pages / Directory Services": { icon: BookOpen, color: "text-yellow-500" },
